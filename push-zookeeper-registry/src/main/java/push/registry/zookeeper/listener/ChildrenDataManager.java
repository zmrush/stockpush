        ...
        try {
            ...
            for (String child : children) {
                ...
                if (lastData == null) {
                    ...
                    eventManager.add(new ChildrenEvent(ChildrenEvent.ChildrenEventType.CHILD_CREATED, path, currentData.getData()));
                } else {
                    //现在存在，比较是否修改
                    if (!Arrays.equals(lastData.getData(), currentData.getData())) {
                        ...
                        result.put(child, currentData);
                        eventManager
                                .add(new ChildrenEvent(ChildrenEvent.ChildrenEventType.CHILD_UPDATED, path, currentData.getData()));
                    } else {
